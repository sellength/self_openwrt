...
echo 'src-git luci https://github.com/jerrykuku/luci-app-vssr.git' >>feeds.conf.default
echo 'src-git luci https://github.com/jerrykuku/lua-maxminddb.git' >>feeds.conf.default
